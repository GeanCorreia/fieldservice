...
internal class SupersetResource2
{
    ...
    protected SupersetResource2() { }
    
    private SupersetResource2(
        Guid id, 
    ...
    public static SupersetResource2 Create(
